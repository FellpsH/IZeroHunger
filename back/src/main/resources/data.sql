...
VALUES (1, 'Banana Prata Premium', 'Banana prata fresca, doce e nutritiva', 3.50, 50, 'Sao Paulo - SP', '2024-12-20', 1, 'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=400&h=300&fit=crop&crop=center');

INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (2, 'Maca Gala Organica', 'Maca gala vermelha, crocante e saborosa', 4.20, 30, 'Sao Paulo - SP', '2024-12-25', 1, 'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=400&h=300&fit=crop&crop=center');

INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (3, 'Alface Crespa Hidroponica', 'Alface crespa fresca, cultivada sem agrotoxicos', 2.80, 25, 'Sao Paulo - SP', '2024-12-18', 1, 'https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?w=400&h=300&fit=crop&crop=center');

INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (4, 'Tomate Cereja Especial', 'Tomate cereja doce, perfeito para saladas', 5.90, 40, 'Sao Paulo - SP', '2024-12-22', 1, 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=400&h=300&fit=crop&crop=center');

INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (5, 'Cenoura Organica Baby', 'Cenoura organica, doce e crocante', 3.20, 35, 'Sao Paulo - SP', '2024-12-30', 1, 'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=400&h=300&fit=crop&crop=center');
...
INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (7, 'Leite Integral Fresh', 'Leite integral 1L, fonte de calcio', 4.80, 15, 'Sao Paulo - SP', '2024-12-28', 1, 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400&h=300&fit=crop&crop=center');

INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (8, 'Pao Frances Artesanal', 'Pao frances fresco, crocante por fora', 1.20, 100, 'Sao Paulo - SP', '2024-12-17', 1, 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&h=300&fit=crop&crop=center');

INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (9, 'Peito de Frango Premium', 'Peito de frango 1kg, sem hormonios', 12.90, 10, 'Sao Paulo - SP', '2024-12-19', 1, 'https://images.unsplash.com/photo-1604503468506-a8da13d82791?w=400&h=300&fit=crop&crop=center');

INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (10, 'Queijo Minas Artesanal', 'Queijo minas frescal, cremoso e saboroso', 15.50, 8, 'Sao Paulo - SP', '2024-12-26', 1, 'https://images.unsplash.com/photo-1552767059-ce182ead6c1b?w=400&h=300&fit=crop&crop=center');

-- Produtos adicionais para diversificar o catalogo
INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (11, 'Abacaxi Perola', 'Abacaxi perola doce e suculento', 6.90, 15, 'Sao Paulo - SP', '2024-12-23', 1, 'https://images.unsplash.com/photo-1550258987-190a2d41a8ba?w=400&h=300&fit=crop&crop=center');

INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (12, 'Brocolis Organico', 'Brocolis fresco, rico em vitaminas', 4.50, 20, 'Sao Paulo - SP', '2024-12-20', 1, 'https://images.unsplash.com/photo-1459411621453-7b03977f4bfc?w=400&h=300&fit=crop&crop=center');
...
INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (15, 'Iogurte Natural', 'Iogurte natural cremoso 500g', 5.90, 12, 'Sao Paulo - SP', '2024-12-21', 1, 'https://images.unsplash.com/photo-1571212515416-fac8c2b1e2c9?w=400&h=300&fit=crop&crop=center');

INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (16, 'Salmao Fresco', 'File de salmao fresco 500g', 28.90, 5, 'Sao Paulo - SP', '2024-12-18', 1, 'https://images.unsplash.com/photo-1544943910-4c1dc44aab44?w=400&h=300&fit=crop&crop=center');
...
INSERT INTO products (id, name, description, price, quantity, location, expiry_date, fornecedor, image) 
VALUES (18, 'Morango Organico', 'Morango organico doce e aromatico', 8.50, 18, 'Sao Paulo - SP', '2024-12-19', 1, 'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?w=400&h=300&fit=crop&crop=center');
